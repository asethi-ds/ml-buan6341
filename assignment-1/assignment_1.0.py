...
def feature_engineering(data):
    ...
    feature_categorical_ohe = ['month','is_weekend','time_of_day']   
...
independent_updated=['T1', 'RH_1', 'T2', 'RH_2', 'T3','RH_3', 'T4', 'RH_4', 'T5', 'RH_5', 'T6', 'RH_6', 'T7', 'RH_7', 'T8',
                      'RH_8', 'T9', 'RH_9', 'T_out', 'Press_mm_hg', 'RH_out', 'Windspeed','Visibility', 'Tdewpoint', 'rv1', 'rv2', 'week_num',
                      'hour_of_day','month_1', 'month_2', 'month_3', 'month_4', 'month_5', 'is_weekend_0','is_weekend_1', 'time_of_day_morning_time'                    , 'time_of_day_night_time','time_of_day_sleep_time', 'time_of_day_work_hours']
...
print(energy_source_data_workset.shape)
